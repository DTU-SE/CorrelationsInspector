...
public class VerticalTableHeaderCellRenderer extends
	...
	private static final long serialVersionUID = 5085854911097548612L;
	...
	/**
	 * An icon implementation to paint the contained icon rotated 90°
	 * clockwise.
	 * <P>
	...
	private enum VerticalSortIcon implements Icon {
		...
		ASCENDING(UIManager.getIcon("Table.ascendingSortIcon")), DESCENDING(
